...
Band 3 karakteriserer \textbf{minne}. \emph{4.3} slår fast at landskapet hugsar med minnehalveringstid $\tau_{\mathrm{mem}}$; lang $\tau_{\mathrm{mem}}$ svarer til kumulative tradisjonar, kort $\tau_{\mathrm{mem}}$ til felt der kvar generasjon kan starte om att. All formgjeving er omformgjeving. \emph{4.4} trekk konsekvensen: formrommet ekspanderer kumulativt.
