...
# --------------------------------------------------------------------------
STIL = (
    "Lag eit boksoppslag i same ånd som dei vedlagde referansane (Andreas Töpfer; "
    "og speculative-realism-bøker som Reza Negarestani sin Cyclonopedia og Graham "
    "Harman sin Quadruple Object). Tenk, observer, planlegg, så teikn.\n\n"
    "TEIKNINGANE DOMINERER: store, SPEKULATIVE penn-og-blekk-teikningar som tek opp "
    "storparten av oppslaget — ofte ei HEIL side. Teikningane ER innhaldet, ikkje pynt "
    "ved sida av teksten: abstrakte omgrep frå teksten gjorde om til uventa, "
    "tankevekkjande fysiske scenar — ansiktslause kroppar som rom og kar, figurar inni "
    "kuler og strukturar, gjennomskjeringar og snitt, ting som morfar til andre ting, "
    "same figur i fleire tilstandar, uvanlege perspektiv. Samanhengande svart "
    "konturlinje på kvitt papir; nokre solide svarte flater og stipla hjelpelinjer er "
    "lov (som i Cyclonopedia); ingen farge, ingen gråtone-skugge. Aldri bokstavlege ikon.\n\n"
    ...
    "IKKJE fyll begge sidene; resten av flata er teikning. Ord for ord, ikkje krot, "
