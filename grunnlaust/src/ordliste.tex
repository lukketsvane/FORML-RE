...
\item[Agent] Den som gjev form, forstått som ein storleik som kan representere nokre aksar og er blind for andre, innanfor ein avgrensa horisont. I rammeverket er designaren \emph{ein} agent blant mange (celle, materiale, marknad, organisasjon) og ikkje den einerådande.
...
\item[Designerly ways of knowing] Cross sitt omgrep for ein eigen, ikkje-proposisjonell designkunnskap. Boka godtek skildringa, men peikar på at ho er bygd så ho alltid stemmer: det som ikkje kan falsifiserast, kan heller ikkje bere eit fag.
...
\item[Falsifiserbarheit] Eigenskapen ved ein påstand at han kan visast gal (Popper). Boka brukar henne som skiljelina mellom eit fundament og ei vakker meining, ikkje som ein dom om at design burde ha vore ein vitskap: det vrange problemet og \emph{designerly ways of knowing} kan ikkje ta feil; \emph{Formlære} kan, og det er det einaste kravet ho stiller til seg sjølv for å kunne kallast ein grunn.
...
\item[Før-paradigmatisk] Kuhns nemning på eit felt utan eit delt paradigme, der skular strir om grunnomgrepa og kunnskapen ikkje hopar seg opp. Boka plasserer designfaget her, men ikkje som eit umode fysikkfag på veg oppover ein skala: design er eit anna slag, strukturelt utan det delte grunnlaget som ber dei paradigmatiske faga, og fråvêret gjer det ikkje til ein mislukka vitskap.
...
\item[Paradigme] Kuhns omgrep for det delte rammeverket av omgrep, metode og målestokkar som lèt eit fag hope opp kunnskap. Designfaget har aldri bygt eit slikt rammeverk for forma si; fråvêret gjer det ikkje til ein mislukka vitskap, men \emph{Formlære} hevdar at eit eige, falsifiserbart grunnlag likevel er mogleg.
...
\item[Risikohandverk vs. visseheitshandverk] Pyes skilje mellom arbeid der resultatet til kvar tid står på spel og avheng av utøvaren si dømekraft (risiko), og arbeid der det er sikra på førehand av maskin eller mal (visse). Merksemda risikoen krev, er sjølv ein form for kunnskap.
...
\item[Taus kunnskap] Den reelle, presise kompetansen som ber prestasjonen utan å la seg formulere: vi veit meir enn vi kan seie (Polanyi). Ekte kunnskap, men ikkje eit fundament; påkalla som forsvar vert han ei orsaking i staden for ein grunn.
